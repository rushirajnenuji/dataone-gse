...
- Report a bug or request a new feature in our [issue tracker](https://github.com/rushirajnenuji/dataone-gse/issues)
...
- add an [issue](https://github.com/rushirajnenuji/dataone-gse/issues) describing your planned changes, or add a comment to an existing issue;
- on GitHub, fork the [repository](https://github.com/rushirajnenuji/dataone-gse)
...
Development is managed through the git repository at https://github.com/rushirajnenuji/dataone-gse.  The repository is organized into several branches, each with a specific purpose.  
...
3. Releases can be downloaded from the [GitHub releases page](https://github.com/rushirajnenuji/dataone-gse/releases).
